...
namespace eval ttk::theme::forest-color-light {

    variable version 1.0
    package provide ttk::theme::forest-color-light $version
    variable colors
    array set colors {
        -fg             "#313131"
        -bg             "#ffffff"
    ...
    LoadImages [file join [file dirname [info script]] forest-color-light]

    # Settings
    ttk::style theme create forest-color-light -parent default -settings {
        ttk::style configure . \
