...
namespace eval ttk::theme::forest-color-dark {

    variable version 1.0
    package provide ttk::theme::forest-color-dark $version
    variable colors
    array set colors {
        -fg             "#eeeeee"
        -bg             "#313131"
    ...
    LoadImages [file join [file dirname [info script]] forest-color-dark]

    # Settings
    ttk::style theme create forest-color-dark -parent default -settings {
        ttk::style configure . \
